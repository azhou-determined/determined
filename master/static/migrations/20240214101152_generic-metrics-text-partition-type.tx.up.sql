/*
 Changes `partition_type` on `metrics` from ENUM type to TEXT.
...
-- Modify child partitions to have `partition_type` TEXT.
-- ALTER TABLE raw_steps ALTER COLUMN partition_type
